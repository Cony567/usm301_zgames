...
@section('contenido')
    <h1>Aquí puedes agregar un juego</h1>
    <div class="row">
        <div class="col-lg-5 col-md-6 col-sm-12 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <label for="consola-select" class="form-label">Consolas</label>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input type="radio" name="apto-rb" id="apto-si-rb" checked class="form-check-input" value="si">
